...
@Component( {
                selector: 'jhi-login-modal', templateUrl: './login.component.html'
            } )
export class JhiLoginModalComponent implements AfterViewInit {
    ...
    cancel() {
        this.credentials = {
            username: null, password: null, rememberMe: true
        };
    ...
    login() {
        this.loginService.login( {
            ...
            if ( this.router.url === '/register' || (/activate/.test( this.router.url )) || this.router.url === '/finishReset' || this.router.url === '/requestReset' ) {
