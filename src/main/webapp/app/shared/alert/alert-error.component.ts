...
export class JhiAlertErrorComponent implements OnDestroy {
    ...
    constructor( private alertService: JhiAlertService, private eventManager: JhiEventManager ) {
        ...
        this.cleanHttpErrorListener = eventManager.subscribe( 'websiteIndexerApp.httpError', ( response ) => {
            let i;
    ...
    addErrorAlert( message, key?, data? ) {
        this.alerts.push( this.alertService.addAlert( {
                                                          type: 'danger', msg: message, timeout: 5000, toast: this.alertService.isToast(), scoped: true
                                                      }, this.alerts ) );
    }
}
