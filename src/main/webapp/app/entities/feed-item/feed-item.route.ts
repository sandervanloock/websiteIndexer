...
export const feedItemRoute: Routes = [{
    path: 'feed-item', component: FeedItemComponent, resolve: {
        'pagingParams': FeedItemResolvePagingParams
    }, data: {
        authorities: ['ROLE_USER'], pageTitle: 'FeedItems'
    }, canActivate: [UserRouteAccessService]
}, {
    path: 'feed-item/:id', component: FeedItemDetailComponent, data: {
        authorities: ['ROLE_USER'], pageTitle: 'FeedItems'
    }, canActivate: [UserRouteAccessService]
}];

export const feedItemPopupRoute: Routes = [{
    path: 'feed-item-new', component: FeedItemPopupComponent, data: {
        authorities: ['ROLE_USER'], pageTitle: 'FeedItems'
    }, canActivate: [UserRouteAccessService], outlet: 'popup'
}, {
    path: 'feed-item/:id/edit', component: FeedItemPopupComponent, data: {
        authorities: ['ROLE_USER'], pageTitle: 'FeedItems'
    }, canActivate: [UserRouteAccessService], outlet: 'popup'
}, {
    path: 'feed-item/:id/delete', component: FeedItemDeletePopupComponent, data: {
        authorities: ['ROLE_USER'], pageTitle: 'FeedItems'
    }, canActivate: [UserRouteAccessService], outlet: 'popup'
}];
