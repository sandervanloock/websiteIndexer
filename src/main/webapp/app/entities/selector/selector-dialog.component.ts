    ...
    save() {
        ...
        if (this.selector.id !== undefined) {
            this.subscribeToSaveResponse(
                this.selectorService.update(this.selector));
        } else {
            this.subscribeToSaveResponse(
                this.selectorService.create(this.selector));
        }
    }
