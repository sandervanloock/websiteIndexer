...
@Component( {
                selector: 'jhi-attribute-delete-dialog', templateUrl: './attribute-delete-dialog.component.html'
            } )
    ...
    confirmDelete( id: number ) {
        this.attributeService.delete( id ).subscribe( ( response ) => {
            this.eventManager.broadcast( {
                                             name: 'attributeListModification', content: 'Deleted an attribute'
                                         } );
...
@Component( {
                selector: 'jhi-attribute-delete-popup', template: ''
            } )
