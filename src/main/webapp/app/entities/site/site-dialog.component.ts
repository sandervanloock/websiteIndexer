...
@Component( {
                selector: 'jhi-site-dialog', templateUrl: './site-dialog.component.html'
            } )
export class SiteDialogComponent implements OnInit {
    ...
    constructor( public activeModal: NgbActiveModal, private alertService: JhiAlertService, private siteService: SiteService, private eventManager: JhiEventManager ) {
    }
    ...
    private subscribeToSaveResponse( result: Observable<Site> ) {
        result.subscribe( ( res: Site ) => this.onSaveSuccess( res ), ( res: Response ) => this.onSaveError( res ) );
    }
...
@Component( {
                selector: 'jhi-site-popup', template: ''
            } )
