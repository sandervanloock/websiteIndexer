...
@Component( {
                selector: 'jhi-site-detail', templateUrl: './site-detail.component.html'
            } )
export class SiteDetailComponent implements OnInit, OnDestroy {
    ...
    constructor( private eventManager: JhiEventManager, private siteService: SiteService, private route: ActivatedRoute ) {
    }
