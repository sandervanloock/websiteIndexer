...
@Component( {
                selector: 'jhi-document-delete-dialog', templateUrl: './document-delete-dialog.component.html'
            } )
    ...
    confirmDelete( id: number ) {
        this.documentService.delete( id ).subscribe( ( response ) => {
            this.eventManager.broadcast( {
                                             name: 'documentListModification', content: 'Deleted an document'
                                         } );
...
@Component( {
                selector: 'jhi-document-delete-popup', template: ''
            } )
