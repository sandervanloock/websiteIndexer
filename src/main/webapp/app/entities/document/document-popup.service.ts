...
export class DocumentPopupService {
    ...
    constructor( private datePipe: DatePipe, private modalService: NgbModal, private router: Router, private documentService: DocumentService ) {
        ...
        return new Promise<NgbModalRef>( ( resolve, reject ) => {
            ...
            if ( id ) {
                this.documentService.find( id ).subscribe( ( document ) => {
                    document.created = this.datePipe
                        .transform( document.created, 'yyyy-MM-ddThh:mm' );
