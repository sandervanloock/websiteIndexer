...
public class SiteCrawler extends WebCrawler implements Crawler {
    ...
    public SiteCrawler(AttributeService attributeService, SelectorRepository selectorRepository, DocumentRepository documentRepository, CrawlerResource controller, JsoupService jsoupService) {
