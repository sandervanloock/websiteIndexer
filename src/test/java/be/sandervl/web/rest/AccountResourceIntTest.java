...
import be.sandervl.domain.Authority;
import be.sandervl.domain.User;
import be.sandervl.repository.AuthorityRepository;
import be.sandervl.repository.UserRepository;
import be.sandervl.security.AuthoritiesConstants;
import be.sandervl.service.MailService;
import be.sandervl.service.UserService;
import be.sandervl.service.dto.UserDTO;
import be.sandervl.web.rest.vm.KeyAndPasswordVM;
import be.sandervl.web.rest.vm.ManagedUserVM;
